...
require_once 'model/demografico_pregunta.php';

class Demografico_preguntaController{

    private $model;

    //Creación del modelo
    public function __CONSTRUCT(){
        $this->model = new demografico_pregunta();
    }
...
if(!isset($_SESSION["usu_codigo"]) || $_SESSION["usu_codigo"]==null){
    ...
    $sesionCodigo=$_SESSION["usu_codigo"];
        $id_permiso=$_REQUEST['id'];
      $permisos = new demografico_pregunta();
    ...
    /*
      if(isset($_REQUEST['idProducto'])){
        ...
        require_once 'view/header.php';
        require_once 'view/evaluacion/evaluacion_demografico.php';
        require_once 'view/footer.php';
  }
