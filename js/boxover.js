...
function defHdrStyle() {
	...
	dvHdr.style.border='1px solid #003466';
	dvHdr.style.padding='2px';
	dvHdr.style.fontSize='11';
	dvHdr.style.color='#FFF';
	dvHdr.style.background=" url('../../pic/16x16/info-chat.png') #003466 no-repeat right top";
	dvHdr.style.filter='alpha(opacity=100)'; // IE
	dvHdr.style.opacity='1'; // FF
}

function defBdyStyle() {
	dvBdy.style.borderBottom='1px solid #003466';
	dvBdy.style.borderLeft='1px solid #003466';
	dvBdy.style.borderRight='1px solid #003466';
	dvBdy.style.width='450px';
	dvBdy.style.fontFamily='arial';
	dvBdy.style.fontSize='11';
	dvBdy.style.padding='2px';
	dvBdy.style.color='#003466';
